...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="title" id="title" minlength="1" maxlength="50" lay-verify="required"
                   ...
                   placeholder="公告标题1-50字符，不能有空格" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea placeholder="请输入公告内容"  name="content" maxlength="255" class="layui-textarea" lay-verify="required" lay-reqtext="公告内容不能为空"></textarea>
        </div>
    </div>
