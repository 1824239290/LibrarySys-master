...
<div class="main-body">
    <div class="login-main">
        ...
        <form class="layui-form login-bottom">
            <div class="center">
                <div class="item">
                    <span class="icon icon-2 required"></span>
                    <input type="text" name="username" id="username" minlength="1" maxlength="6" lay-verify="required"
                           lay-reqtext="用户名不能为空"
                           placeholder="用户名1-6字符，不能有空格" class="layui-input">
                </div>

                <div class="item">
                    <span class="icon icon-3 required"></span>
                    <input type="password" name="password" minlength="6" maxlength="16" lay-verify="required|pass"
                           lay-reqtext="密码不能为空"
                           placeholder="密码6-16字符，不能有空格" class="layui-input">
                ...
                <div class="item">
                    <span class="icon icon-1 required"></span>
                    <input type="text" name="sex" maxlength="1" lay-verify="required|sex" lay-reqtext="性别不能为空"
                           placeholder="性别只能为男或女" class="layui-input">
                </div>

                <div class="item">
                    <span class="icon icon-1"></span>
                    <input type="text" name="birthday" id="date" placeholder="请选择出生日期" lay-verify="required" lay-reqtext="出生日期不能为空" class="layui-input" >
                </div>
                ...
                <div class="item required" style="width: 137px;">
            ...
            <div class="tip">
                <span class="forget-password" id="login" style='cursor:pointer;'>已有账号？立即登录</span>
            </div>
            <div class="layui-form-item" style="text-align:center; width:100%;height:100%;margin:0px;">
                <button class="login-btn" lay-submit="" lay-filter="registerNow">立即注册</button>
            </div>
        </form>
    </div>
</div>
<div class="footer">
    ©版权所有 2022 <span class="padding-5">|</span><a target="_blank" >备案号暂为空</a>
</div>
