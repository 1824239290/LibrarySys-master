        ...
        <div class="layuimini-header-content">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting">
                    <a href="javascript:;">
                        <img src="${pageContext.request.contextPath}/images/Logo.png" id="userImage"
                             class="layui-nav-img">
                        ${sessionScope.name}
                    </a>
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;"
                               layuimini-content-href="${pageContext.request.contextPath}/setting"
                               data-title="基本资料" data-icon="fa fa-gears">基本资料<span class="layui-badge-dot"></span></a>
                        </dd>
                        <dd>
                            <a href="javascript:;"
                               layuimini-content-href="${pageContext.request.contextPath}/toUpPwd"
                               data-title="修改密码" data-icon="fa fa-gears">修改密码</a>
                        </dd>
                        <dd>
                            <a href="javascript:;"
                               data-title="上传头像" data-icon="fa fa-gears" id="upload">上传头像</a>
                        </dd>
                        <dd>
                            <hr>
                        </dd>
    ...
    layui.use(['jquery', 'layer', 'miniAdmin', 'miniTongji'], function () {
        ...
        $("#upload").on('click',function (){
            const index = layer.open({
                ...
                shadeClose: true,
                area: ['50%', '50%'],
                content: '${pageContext.request.contextPath}/photo/toUpload',
            });
        ...
        $(document).ready(function () {
            $.ajax({
                url: "${pageContext.request.contextPath}/photo/queryPhoto",
                type: "POST",
                contentType: "application/json;charset=utf-8",
                success: function (result) {
                    if (result.code === 1) {
                        $('#userImage').attr("src", result.data.picture);
                    }
                }
            });
        });
        ...
        const options = {
            ...
            iniUrl: "${pageContext.request.contextPath}/api/init1.json",//初始化接口，普通管理员
            </c:when>
