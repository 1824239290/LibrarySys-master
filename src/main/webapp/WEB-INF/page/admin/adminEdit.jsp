...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="username" id="username" minlength="1" maxlength="6" lay-verify="required"
                   ...
                   placeholder="管理员名称1-6字符，不能有空格" class="layui-input" value="${admin.username}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="realName" minlength="2" maxlength="4" placeholder="真实姓名只能为2-4个汉字"
                   class="layui-input"
                   lay-verify="required|name" lay-reqtext="真实姓名不能为空" value="${admin.realName}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="radio" name="sex"  value="男" title="男"  ${"男" eq admin.sex ?"checked='checked'":''}>
            <input type="radio" name="sex"  value="女" title="女"  ${"女" eq admin.sex ?"checked='checked'":''}>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="birthday" id="date" placeholder="请选择出生日期" class="layui-input" value="<fmt:formatDate value="${admin.birthday}" pattern="yyyy-MM-dd"/>" lay-verify="required" lay-reqtext="出生日期不能为空">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="address" maxlength="50" placeholder="请输入地址(可为空)" class="layui-input" value="${admin.address}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="tel" name="tel" lay-verify="tel" maxlength="11" placeholder="请输入手机号(可为空)"
                   class="layui-input" value="${admin.tel}">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="radio" name="userStatus" value="1" title="正常" ${"1" eq admin.userStatus ?"checked='checked'":''}>
            <input type="radio" name="userStatus" value="0" title="冻结" ${"0" eq admin.userStatus ?"checked='checked'":''}>
        </div>
    </div>
