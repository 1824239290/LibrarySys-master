...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="bookName" id="bookName" minlength="1" maxlength="16" lay-verify="required"
                   ...
                   placeholder="图书名称1-16字符，不能有空格" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="author" minlength="1" maxlength="16" placeholder="1-16个字符，不能有空格"
                   class="layui-input"
                   lay-verify="required|other" lay-reqtext="图书作者不能为空">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="press" minlength="1" maxlength="16" placeholder="1-16个字符，不能有空格"
                   class="layui-input"
                   lay-verify="required|other" lay-reqtext="出版社不能为空">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea placeholder="请输入书籍简介"  name="bookDescription" maxlength="255" class="layui-textarea" lay-verify="required" lay-reqtext="书籍简介不能为空"></textarea>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="bookLanguage" minlength="1" maxlength="16" placeholder="1-16个字符，不能有空格"
                   class="layui-input"
                   lay-verify="required|other" lay-reqtext="书籍语言不能为空">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="number" name="bookPrice" oninput="if(value.length>3)value=value.slice(0,3)" placeholder="只能输入整数,最高999"
                   class="layui-input"
                   lay-verify="required" lay-reqtext="书籍价格不能为空">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="publicationTime" id="date" placeholder="请选择出版日期" class="layui-input" lay-verify="required" lay-reqtext="出版日期不能为空">
        </div>
    </div>
