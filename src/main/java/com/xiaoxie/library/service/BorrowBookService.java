...
public interface BorrowBookService {
    ...
    //查询所有借阅数据
    PageInfo<BorrowBook> selectAllBorrowBook(@Param("borrowBook") BorrowBook borrowBook,@Param("pageNum") Integer pageNum, @Param("pageSize") Integer pageSize);
    ...
    //批量更新借阅记录为正常还书
    int updateBorrowBookStatusById(BorrowBook borrowBook,List<String> ids);
